...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2021 at 03:05 PM
...
--
-- Database: `db_aplikasiku1811500025`
--

-- --------------------------------------------------------

--
-- Table structure for table `hospital1811500025`
--

CREATE TABLE `hospital1811500025` (
  `id` int(8) NOT NULL,
...
--
-- Dumping data for table `hospital1811500025`
--

INSERT INTO `hospital1811500025` (`id`, `nama`, `latitude`, `longitude`) VALUES
...
--
-- Table structure for table `restaurant1811500025`
--

CREATE TABLE `restaurant1811500025` (
  `id` int(8) NOT NULL,
  `nama` varchar(30) CHARACTER SET latin1 NOT NULL,
  `latitude` double NOT NULL,
  `longitude` double NOT NULL
...
--
-- Dumping data for table `restaurant1811500025`
--

INSERT INTO `restaurant1811500025` (`id`, `nama`, `latitude`, `longitude`) VALUES
...
--
-- Table structure for table `sekolah1811500025`
--

CREATE TABLE `sekolah1811500025` (
  `id` int(8) NOT NULL,
  `nama` varchar(30) CHARACTER SET latin1 NOT NULL,
  `latitude` double NOT NULL,
  `longitude` double NOT NULL
...
--
-- Dumping data for table `sekolah1811500025`
--

INSERT INTO `sekolah1811500025` (`id`, `nama`, `latitude`, `longitude`) VALUES
...
--
-- Indexes for table `hospital1811500025`
--
ALTER TABLE `hospital1811500025`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `restaurant1811500025`
--
ALTER TABLE `restaurant1811500025`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sekolah1811500025`
--
ALTER TABLE `sekolah1811500025`
  ADD PRIMARY KEY (`id`);
COMMIT;
